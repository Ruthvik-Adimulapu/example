...
def data_over_time(df, col):
    # Drop duplicates and count the occurrences of 'Year'
    nations_over_time = df.drop_duplicates(['Year', col])['Year'].value_counts().reset_index()

    # Rename the columns:
    # 'index' becomes 'Edition', and the count column becomes 'count'
    nations_over_time.columns = ['Edition', 'count']

    return nations_over_time.sort_values(by='Edition')  # Sort by Edition (or Year)
